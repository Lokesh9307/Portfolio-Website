      ...
      <main className=' bg-black w-full lg:h-[86vh] flex justify-between items-center py-4 overflow-hidden lg:px-10 px-6 lg:flex-row flex-col relative z-50' id='showcase__container'>
        <section className='flex flex-col justify-between lg:items-start items-center'>
          ...
          <div className='flex flex-col gap-3 justify-center items-center'>
            <Link href='/pdf/Lokesh Umredkar.pdf' className='text-center flex justify-center items-center text-xl border-2 border-[#c7f9cc] w-[10rem] p-3 rounded-lg text-green-400 mt-6 hover:border-green-600'>Resume</Link>
